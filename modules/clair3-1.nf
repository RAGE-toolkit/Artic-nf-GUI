...
process CLAIR3 {
	...
	script:
		if( !input_bam.exists() )
			exit 1, "CLAIR3: Input BAM not found: ${input_bam}"
		if( !reference.exists() )
			exit 1, "CLAIR3: Reference not found: ${reference}"
		...
		bgzip -dc clair3_pool1/merge_output.vcf.gz > "${params.run_name}_${sampleId}.1.vcf"
		"""
}
